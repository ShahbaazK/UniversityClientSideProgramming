...
class showInfoData {
    ...
    protected $_trainer_id,$_trainer_name, $_trainer_image, $protected_trainer_features, $_trainer_type, $_trainer_price, $_trainer_stock, $_advert_start_date, $_advert_end_date, $_location_, $_longitude_, $_latitude_, $_city_;
    ...
    public function __construct($dbRow) {
        ...
        $this->_location_ = $dbRow['trainer_location'];
        $this->_longitude_ = $dbRow['latitude'];
        $this->_latitude_ = $dbRow['longitude'];
        $this->_city_ = $dbRow['city'];
    }
